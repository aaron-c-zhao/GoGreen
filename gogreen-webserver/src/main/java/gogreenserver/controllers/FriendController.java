...
public class FriendController {
    ...
    /**
     * This end point serves for finding all records of a user's friends. If one or more than one
     * of its friends dont have a record then a INTERAL_SERVER_ERROR will be return. If this user
     * does not have any friend then a NOT_FOUND will be return. Client side should handle these
     * two error status.
     *
